    ...
    <div className="p-6">
      ...
      <div className="mb-6">
        <nav className="flex items-center text-sm">
          ...
          <span className="text-[#2f5e37] font-medium">Doctors</span>
        </nav>
        <h1 className="text-2xl font-bold text-gray-800 mt-2">Affiliate Doctors</h1>
      </div>
      ...
      <div className="bg-white p-6 rounded-2xl" style={{ boxShadow: "rgba(100, 100, 111, 0.2) 0px 7px 29px 0px" }}>
        ...
        <p className="text-gray-600">Affiliate Doctors management will appear here.</p>
      </div>
    </div>
  );
};
